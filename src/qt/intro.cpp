...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Kingston Core"),
     ...
     * override -datadir in the kingston.conf file in the default data directory
     * (to be consistent with kingstond behavior)
     */
    if (dataDir != getDefaultDataDirectory())
