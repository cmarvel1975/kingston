                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Kingston Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Kingston address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kingston: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Kingston Core"), this);
    aboutAction->setStatusTip(tr("Show information about Kingston Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Kingston"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Kingston addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Kingston addresses"));
    ...
    openAction->setStatusTip(tr("Open a Kingston: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Kingston Core help message to get a list with possible Kingston command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Kingston Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Kingston network", "", count));
}
...
{
    QString strTitle = tr("Kingston Core"); // default title
