...
public:
	...
	const char* pszTimestamp = "Dixicoin Official Release";
        ...
        vSeeds.push_back(CDNSSeedData("1", "81.169.179.241"));
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1521117400;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 12345;
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 9215;
        //assert(hashGenesisBlock == uint256("0x00000774d9ca930a115f44612b9bf2990639b847bb9b56bbe72ba98adc85acb7"));
